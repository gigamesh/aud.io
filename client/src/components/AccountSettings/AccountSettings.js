          ...
          <Grid container spacing={24}>
            ...
            <MyFormControl fullWidth>
              ...
              <Grid container spacing={8}>
                ...
                <Grid item xs={4} sm={3} md={2} lg={3} style={{width: '100%'}} >
                  <FormControl 
                ...
                <Grid item xs={8} sm={9} md={4} lg={3} style={{width: '100%'}} >
                  <MyFormControl fullWidth
                    // error={touched.password && errors.password}
                    >
                      <Input
...
const FormikForm = withFormik({
  ...
  validationSchema: yup.object().shape({
    ...
    firstName: yup.string().max(50, params => `May not exceed ${params.max} characters`),
    lastName: yup.string().max(50, params => `May not exceed ${params.max} characters`),
    street: yup.string().max(100, params => `May not exceed ${params.max} characters`),
    city: yup.string().max(50, params => `May not exceed ${params.max} characters`),
    state: yup.string(),
