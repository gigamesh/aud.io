...
const ProfileNameWrap = styled.div`
  ...
  width: 98%;
  flex-shrink: 10;
  color: ${({ profilenameColor }: { profilenameColor: string }) =>
      ...
      <Link to={`/user/${userId}`}>
        <OuterWrap>
          <MyCard raised>
            ...
            <InnerWrap className="usercard--innerwrap" src={this.state.src}>
              <div style={{ flexGrow: 1, width: "100%" }} />
            </InnerWrap>
            <ProfileNameWrap
              className={"headercard-profilename"}
              profilenameColor={user.profilenameColor as string}
            >
