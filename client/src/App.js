          ...
          >
            <Switch location={this.props.location} key="switch">
              <Route
                path="/"
                exact
                component={FullWrapAndCenter(BigAnimatedLogo)}
              />
              <Route path="/login" component={FullWrapAndCenter(Form_Login)} />
              <Route path="/logout" component={FullWrapAndCenter(Logout)} />
              <Route
                path="/accountsettings"
                component={FullWrapAndCenter(AccountSettings, width)}
              />
              <Route path="/user/:id" component={FullWrap(UserProfile)} />
              <Route path="/studios" component={FullWrap(UsersGridLayout)} />
              <Route path="/musicians" component={FullWrap(UsersGridLayout)} />
              <Route path="/gear" component={FullWrap(Gear)} />
              <Route
                path="/signup"
                component={FullWrapAndCenter(Form_Signup)}
              />
